...
<body>
    <nav class="top-nav">
        ...
        <?php
            ...
            echo $this->Html->Link('Frais', ['plugin' => NULL, 'controller' => 'packages', 'action' => 'index']);
            echo $this->Html->Link('Hors forfait', ['plugin' => NULL, 'controller' => 'outpackages', 'action' => 'index']);
